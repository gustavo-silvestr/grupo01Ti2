...
public class DAO {
	...
	public boolean inserirUsuario(Usuario usuario) {
		...
		try {  
			...
			st.executeUpdate("INSERT INTO usuario (codigo, email, senha, nome) "
	         ...
	         if(rs.next()){
	             ...
	             for(int i = 0; rs.next(); i++) {
	                usuarios[i] = new Usuario(rs.getInt("codigo"), rs.getString("email"), 
	                		                  rs.getString("senha"), rs.getString("sexo").charAt(0), rs.getString("cpf"),
	                		                  rs.getString("nome"), rs.getString("sobrenome"), rs.getString("cep"), rs.getString("estado")
